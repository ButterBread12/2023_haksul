  ...
  <div id="app">
    ...
    <v-expansion-panels focusable>
      <v-expansion-panel v-for="i in 1" :key="i">
        <v-expansion-panel-title>등록된 병원 정보</v-expansion-panel-title>
            ...
            <template v-slot:item="row">
              <tr>
                ...
                <td class="text-xs-right">
                  ...
                  <v-btn color="primary" v-on:click.native="sendEvent2(row.item)">진료실보기</v-btn>
                  ...
                  <v-btn color="primary" v-on:click.native="sendEvent(row.item)">병원 위치</v-btn>
                  <v-btn color="primary" v-on:click.native="sendEvent1(row.item)">예약조회</v-btn>
...
export default {
  ...
  methods: {
    ...
    sendEvent1(data) {
      this.$bus.$emit('Reservate1', data);
    },
    sendEvent2(data) {
      this.$bus.$emit('deviceSelected1', data);
    },
